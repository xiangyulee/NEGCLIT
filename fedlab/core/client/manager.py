...
class PassiveClientManager(ClientManager):
        ...
        while True:
            ...
            if message_code == MessageCode.Exit:
                ...
                if self._trainer.type == SERIAL_TRAINER:
                    self._trainer.local_process(args,payload=payload, id_list=id_list)

                elif self._trainer.type == ORDINARY_TRAINER:
                    assert len(id_list) == 1
                    self._trainer.local_process(args,payload=payload, id=id_list[0])
    ...
    def synchronize(self):
        ...
        # print(self._trainer.type)
        # self._trainer.type = SERIAL_TRAINER
